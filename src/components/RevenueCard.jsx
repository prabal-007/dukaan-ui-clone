...
const RevenueCard = () => {
    return (
        <div className='border-2 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 text-sm font-system-ui bg-slate-100'>
            <div className='col-span-1 m-2 rounded-lg bg-blue-400 p-0 pt-3 text-white'>
...
const WhiteCard = ({ title, amount, order, active }) => {
    return (
        <div className='col-span-1 m-2 rounded-lg bg-white p-0 pt-3'>
