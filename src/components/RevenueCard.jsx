...
const RevenueCard = () => {
    return (
        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 text-sm font-system-ui'>
            <div className='col-span-1 m-2 rounded-md bg-blue-400 p-0 pt-3 text-white shadow-md'>
                ...
                <div className='flex justify-between rounded-t-none rounded-md p-2 pt-1 px-6 bg-blue-700'>
...
const WhiteCard = ({ title, amount, order, active }) => {
    return (
        <div className='col-span-1 m-2 rounded-md bg-white p-0 pt-3 h-fit shadow-md'>
